...
*/
void set_simulation_parameter( NSInteger maxsporen, NSInteger start_pop, NSInteger spread, NSInteger rnd_kind,
 			NSInteger cloud, NSInteger eat  )
{
	if( maxsporen > REAL_MAX_SPOREN )
		maxsporen = REAL_MAX_SPOREN;

	MAX_SPOREN = (int) maxsporen;

	random_kind = (int) rnd_kind;
	start_population = (int) (start_pop / 3);
	start_spread = (int) spread;
	start_cloud = (int) cloud;
	eatOne = (int)eat;
